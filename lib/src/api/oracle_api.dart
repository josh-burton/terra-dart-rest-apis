...
class OracleApi {
  ...
  Future<Response<BuiltList<String>>> oracleDenomsActivesGet({ 
    ...
    final _path = r'/oracle/denoms/actives';
  ...
  Future<Response<BuiltList<OracleDenomsExchangeRatesGet200ResponseInner>>> oracleDenomsExchangeRatesGet({ 
    ...
    final _path = r'/oracle/denoms/exchange_rates';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<num>> oracleVotersValidatorMissGet({ 
    ...
    final _path = r'/oracle/voters/{validator}/miss'.replaceAll('{' r'validator' '}', validator.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
