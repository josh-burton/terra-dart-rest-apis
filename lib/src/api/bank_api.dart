...
class BankApi {
  ...
  ///
  /// Parameters:
  /// * [account] - Account address in bech32 format
  /// * [contentType] - 
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetBankResult] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetBankResult>> getaccountinformation({ 
    ...
    final _path = r'/v1/bank/{account}'.replaceAll('{' r'account' '}', account.toString());
    ...
    GetBankResult _responseData;

    try {
      const _responseType = FullType(GetBankResult);
  ...
  Future<Response<BuiltList<Coin>>> gettheaccountbalances({ 
    ...
    final _path = r'/bank/balances/{address}'.replaceAll('{' r'address' '}', address.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<StdTx>> sendcoinsfromoneaccounttoanother({ 
    ...
    final _path = r'/bank/accounts/{address}/transfers'.replaceAll('{' r'address' '}', address.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<String>> totalsupplyofasinglecoindenomination({ 
    ...
    final _path = r'/bank/total/{denomination}'.replaceAll('{' r'denomination' '}', denomination.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Supply] as data
  /// Throws [DioError] if API call or serialization fails
  @Deprecated('This operation has been deprecated')
  Future<Response<Supply>> totalsupplyofcoinsinthechain({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    Supply _responseData;

    try {
      const _responseType = FullType(Supply);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as Supply;
