...
part 'tendermint_types_block_header.g.dart';
...
/// * [evidenceHash] 
/// * [proposerAddress] 
abstract class TendermintTypesBlockHeader implements Built<TendermintTypesBlockHeader, TendermintTypesBlockHeaderBuilder> {
    ...
    TendermintTypesBlockHeader._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(TendermintTypesBlockHeaderBuilder b) => b;

    factory TendermintTypesBlockHeader([void updates(TendermintTypesBlockHeaderBuilder b)]) = _$TendermintTypesBlockHeader;

    @BuiltValueSerializer(custom: true)
    static Serializer<TendermintTypesBlockHeader> get serializer => _$TendermintTypesBlockHeaderSerializer();
}

class _$TendermintTypesBlockHeaderSerializer implements StructuredSerializer<TendermintTypesBlockHeader> {
    @override
    final Iterable<Type> types = const [TendermintTypesBlockHeader, _$TendermintTypesBlockHeader];

    @override
    final String wireName = r'TendermintTypesBlockHeader';

    @override
    Iterable<Object?> serialize(Serializers serializers, TendermintTypesBlockHeader object,
    ...
    @override
    TendermintTypesBlockHeader deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TendermintTypesBlockHeaderBuilder();
