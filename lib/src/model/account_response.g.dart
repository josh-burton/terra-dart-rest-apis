...
class _$AccountResponse extends AccountResponse {
  ...
  _$AccountResponse._({this.account}) : super._();
  ...
  bool operator ==(Object other) {
    ...
    return other is AccountResponse && account == other.account;
  }
...
class AccountResponseBuilder
  ...
  _$AccountResponse _build() {
    ...
    try {
      _$result = _$v ?? new _$AccountResponse._(account: _account?.build());
    } catch (_) {
