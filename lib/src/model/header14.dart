...
/// * [evidenceHash] 
/// * [proposerAddress] 
abstract class Header14 implements Built<Header14, Header14Builder> {
    ...
    static void _defaults(Header14Builder b) => b;

    factory Header14([void updates(Header14Builder b)]) = _$Header14;

    @BuiltValueSerializer(custom: true)
    static Serializer<Header14> get serializer => _$Header14Serializer();
}

class _$Header14Serializer implements StructuredSerializer<Header14> {
    @override
    final Iterable<Type> types = const [Header14, _$Header14];

    @override
    final String wireName = r'Header14';

    @override
    Iterable<Object?> serialize(Serializers serializers, Header14 object,
    ...
    @override
    Header14 deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = Header14Builder();
