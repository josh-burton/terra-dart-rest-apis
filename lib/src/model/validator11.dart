...
abstract class Validator11 implements Built<Validator11, Validator11Builder> {
    ...
    static void _defaults(Validator11Builder b) => b;

    factory Validator11([void updates(Validator11Builder b)]) = _$Validator11;

    @BuiltValueSerializer(custom: true)
    static Serializer<Validator11> get serializer => _$Validator11Serializer();
}

class _$Validator11Serializer implements StructuredSerializer<Validator11> {
    @override
    final Iterable<Type> types = const [Validator11, _$Validator11];

    @override
    final String wireName = r'Validator11';

    @override
    Iterable<Object?> serialize(Serializers serializers, Validator11 object,
    ...
    @override
    Validator11 deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = Validator11Builder();
