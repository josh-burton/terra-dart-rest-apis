...
part 'mintingmoduleparameters_response.g.dart';
...
/// * [goalBonded] 
/// * [blocksPerYear] 
abstract class MintingmoduleparametersResponse implements Built<MintingmoduleparametersResponse, MintingmoduleparametersResponseBuilder> {
    ...
    MintingmoduleparametersResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(MintingmoduleparametersResponseBuilder b) => b;

    factory MintingmoduleparametersResponse([void updates(MintingmoduleparametersResponseBuilder b)]) = _$MintingmoduleparametersResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<MintingmoduleparametersResponse> get serializer => _$MintingmoduleparametersResponseSerializer();
}

class _$MintingmoduleparametersResponseSerializer implements StructuredSerializer<MintingmoduleparametersResponse> {
    @override
    final Iterable<Type> types = const [MintingmoduleparametersResponse, _$MintingmoduleparametersResponse];

    @override
    final String wireName = r'MintingmoduleparametersResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, MintingmoduleparametersResponse object,
    ...
    @override
    MintingmoduleparametersResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = MintingmoduleparametersResponseBuilder();
