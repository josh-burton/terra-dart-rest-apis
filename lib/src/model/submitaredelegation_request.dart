...
part 'submitaredelegation_request.g.dart';
...
/// * [amount] - 
abstract class SubmitaredelegationRequest implements Built<SubmitaredelegationRequest, SubmitaredelegationRequestBuilder> {
    ...
    SubmitaredelegationRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(SubmitaredelegationRequestBuilder b) => b;

    factory SubmitaredelegationRequest([void updates(SubmitaredelegationRequestBuilder b)]) = _$SubmitaredelegationRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<SubmitaredelegationRequest> get serializer => _$SubmitaredelegationRequestSerializer();
}

class _$SubmitaredelegationRequestSerializer implements StructuredSerializer<SubmitaredelegationRequest> {
    @override
    final Iterable<Type> types = const [SubmitaredelegationRequest, _$SubmitaredelegationRequest];

    @override
    final String wireName = r'SubmitaredelegationRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, SubmitaredelegationRequest object,
    ...
    @override
    SubmitaredelegationRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = SubmitaredelegationRequestBuilder();
