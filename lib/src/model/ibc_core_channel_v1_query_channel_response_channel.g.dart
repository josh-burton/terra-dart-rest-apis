...
part of 'ibc_core_channel_v1_query_channel_response_channel.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$IbcCoreChannelV1QueryChannelResponseChannel
    extends IbcCoreChannelV1QueryChannelResponseChannel {
  @override
  ...
  factory _$IbcCoreChannelV1QueryChannelResponseChannel(
          [void Function(IbcCoreChannelV1QueryChannelResponseChannelBuilder)?
              updates]) =>
      (new IbcCoreChannelV1QueryChannelResponseChannelBuilder()
            ..update(updates))
          ._build();

  _$IbcCoreChannelV1QueryChannelResponseChannel._(
      {this.state,
      this.ordering,
      this.counterparty,
      this.connectionHops,
  ...
  @override
  IbcCoreChannelV1QueryChannelResponseChannel rebuild(
          void Function(IbcCoreChannelV1QueryChannelResponseChannelBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  IbcCoreChannelV1QueryChannelResponseChannelBuilder toBuilder() =>
      new IbcCoreChannelV1QueryChannelResponseChannelBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is IbcCoreChannelV1QueryChannelResponseChannel &&
        state == other.state &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'IbcCoreChannelV1QueryChannelResponseChannel')
          ..add('state', state)
...
class IbcCoreChannelV1QueryChannelResponseChannelBuilder
    implements
        Builder<IbcCoreChannelV1QueryChannelResponseChannel,
            IbcCoreChannelV1QueryChannelResponseChannelBuilder> {
  _$IbcCoreChannelV1QueryChannelResponseChannel? _$v;
  ...
  IbcCoreChannelV1QueryChannelResponseChannelBuilder() {
    IbcCoreChannelV1QueryChannelResponseChannel._defaults(this);
  }

  IbcCoreChannelV1QueryChannelResponseChannelBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _state = $v.state;
  ...
  @override
  void replace(IbcCoreChannelV1QueryChannelResponseChannel other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$IbcCoreChannelV1QueryChannelResponseChannel;
  }
  ...
  @override
  IbcCoreChannelV1QueryChannelResponseChannel build() => _build();

  _$IbcCoreChannelV1QueryChannelResponseChannel _build() {
    _$IbcCoreChannelV1QueryChannelResponseChannel _$result;
    try {
      _$result = _$v ??
          new _$IbcCoreChannelV1QueryChannelResponseChannel._(
              state: state,
              ordering: ordering,
