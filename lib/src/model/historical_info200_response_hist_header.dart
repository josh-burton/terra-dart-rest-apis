...
part 'historical_info200_response_hist_header.g.dart';
...
/// * [evidenceHash] 
/// * [proposerAddress] 
abstract class HistoricalInfo200ResponseHistHeader implements Built<HistoricalInfo200ResponseHistHeader, HistoricalInfo200ResponseHistHeaderBuilder> {
    ...
    HistoricalInfo200ResponseHistHeader._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(HistoricalInfo200ResponseHistHeaderBuilder b) => b;

    factory HistoricalInfo200ResponseHistHeader([void updates(HistoricalInfo200ResponseHistHeaderBuilder b)]) = _$HistoricalInfo200ResponseHistHeader;

    @BuiltValueSerializer(custom: true)
    static Serializer<HistoricalInfo200ResponseHistHeader> get serializer => _$HistoricalInfo200ResponseHistHeaderSerializer();
}

class _$HistoricalInfo200ResponseHistHeaderSerializer implements StructuredSerializer<HistoricalInfo200ResponseHistHeader> {
    @override
    final Iterable<Type> types = const [HistoricalInfo200ResponseHistHeader, _$HistoricalInfo200ResponseHistHeader];

    @override
    final String wireName = r'HistoricalInfo200ResponseHistHeader';

    @override
    Iterable<Object?> serialize(Serializers serializers, HistoricalInfo200ResponseHistHeader object,
        ...
        if (object.lastBlockId != null) {
            result
                ...
                ..add(serializers.serialize(object.lastBlockId,
                    specifiedType: const FullType(PrevBlockInfo)));
        }
    ...
    @override
    HistoricalInfo200ResponseHistHeader deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = HistoricalInfo200ResponseHistHeaderBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'last_block_id':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(PrevBlockInfo)) as PrevBlockInfo;
