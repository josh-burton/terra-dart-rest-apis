...
part of 'cosmos_auth_v1beta1_query_params_response_params.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CosmosAuthV1beta1QueryParamsResponseParams
    extends CosmosAuthV1beta1QueryParamsResponseParams {
  @override
  ...
  factory _$CosmosAuthV1beta1QueryParamsResponseParams(
          [void Function(CosmosAuthV1beta1QueryParamsResponseParamsBuilder)?
              updates]) =>
      (new CosmosAuthV1beta1QueryParamsResponseParamsBuilder()..update(updates))
          ._build();

  _$CosmosAuthV1beta1QueryParamsResponseParams._(
  ...
  @override
  CosmosAuthV1beta1QueryParamsResponseParams rebuild(
          void Function(CosmosAuthV1beta1QueryParamsResponseParamsBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CosmosAuthV1beta1QueryParamsResponseParamsBuilder toBuilder() =>
      new CosmosAuthV1beta1QueryParamsResponseParamsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CosmosAuthV1beta1QueryParamsResponseParams &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'CosmosAuthV1beta1QueryParamsResponseParams')
...
class CosmosAuthV1beta1QueryParamsResponseParamsBuilder
    implements
        Builder<CosmosAuthV1beta1QueryParamsResponseParams,
            CosmosAuthV1beta1QueryParamsResponseParamsBuilder> {
  _$CosmosAuthV1beta1QueryParamsResponseParams? _$v;
  ...
  CosmosAuthV1beta1QueryParamsResponseParamsBuilder() {
    CosmosAuthV1beta1QueryParamsResponseParams._defaults(this);
  }

  CosmosAuthV1beta1QueryParamsResponseParamsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(CosmosAuthV1beta1QueryParamsResponseParams other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$CosmosAuthV1beta1QueryParamsResponseParams;
  }
  ...
  @override
  CosmosAuthV1beta1QueryParamsResponseParams build() => _build();

  _$CosmosAuthV1beta1QueryParamsResponseParams _build() {
    final _$result = _$v ??
        new _$CosmosAuthV1beta1QueryParamsResponseParams._(
