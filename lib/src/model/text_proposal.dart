...
/// * [votingStartTime] 
/// * [votingEndTime] 
abstract class TextProposal implements Built<TextProposal, TextProposalBuilder> {
    ...
    static void _defaults(TextProposalBuilder b) => b;

    factory TextProposal([void updates(TextProposalBuilder b)]) = _$TextProposal;

    @BuiltValueSerializer(custom: true)
    static Serializer<TextProposal> get serializer => _$TextProposalSerializer();
}

class _$TextProposalSerializer implements StructuredSerializer<TextProposal> {
    @override
    final Iterable<Type> types = const [TextProposal, _$TextProposal];

    @override
    final String wireName = r'TextProposal';

    @override
    Iterable<Object?> serialize(Serializers serializers, TextProposal object,
    ...
    @override
    TextProposal deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TextProposalBuilder();
