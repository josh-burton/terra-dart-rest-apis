...
import 'package:terra_dart_rest_apis/src/model/event1.dart';
...
abstract class TxResponse implements Built<TxResponse, TxResponseBuilder> {
    ...
    static void _defaults(TxResponseBuilder b) => b;

    factory TxResponse([void updates(TxResponseBuilder b)]) = _$TxResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<TxResponse> get serializer => _$TxResponseSerializer();
}

class _$TxResponseSerializer implements StructuredSerializer<TxResponse> {
    @override
    final Iterable<Type> types = const [TxResponse, _$TxResponse];

    @override
    final String wireName = r'TxResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, TxResponse object,
    ...
    @override
    TxResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TxResponseBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'events':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(Event1)])) as BuiltList<Event1>;
