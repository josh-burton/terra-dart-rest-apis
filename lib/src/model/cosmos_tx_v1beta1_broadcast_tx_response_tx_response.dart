...
part 'cosmos_tx_v1beta1_broadcast_tx_response_tx_response.g.dart';
...
abstract class CosmosTxV1beta1BroadcastTxResponseTxResponse implements Built<CosmosTxV1beta1BroadcastTxResponseTxResponse, CosmosTxV1beta1BroadcastTxResponseTxResponseBuilder> {
    ...
    CosmosTxV1beta1BroadcastTxResponseTxResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(CosmosTxV1beta1BroadcastTxResponseTxResponseBuilder b) => b;

    factory CosmosTxV1beta1BroadcastTxResponseTxResponse([void updates(CosmosTxV1beta1BroadcastTxResponseTxResponseBuilder b)]) = _$CosmosTxV1beta1BroadcastTxResponseTxResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<CosmosTxV1beta1BroadcastTxResponseTxResponse> get serializer => _$CosmosTxV1beta1BroadcastTxResponseTxResponseSerializer();
}

class _$CosmosTxV1beta1BroadcastTxResponseTxResponseSerializer implements StructuredSerializer<CosmosTxV1beta1BroadcastTxResponseTxResponse> {
    @override
    final Iterable<Type> types = const [CosmosTxV1beta1BroadcastTxResponseTxResponse, _$CosmosTxV1beta1BroadcastTxResponseTxResponse];

    @override
    final String wireName = r'CosmosTxV1beta1BroadcastTxResponseTxResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, CosmosTxV1beta1BroadcastTxResponseTxResponse object,
    ...
    @override
    CosmosTxV1beta1BroadcastTxResponseTxResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = CosmosTxV1beta1BroadcastTxResponseTxResponseBuilder();
