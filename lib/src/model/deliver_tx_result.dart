...
/// * [log] 
/// * [tags] 
abstract class DeliverTxResult implements Built<DeliverTxResult, DeliverTxResultBuilder> {
    ...
    static void _defaults(DeliverTxResultBuilder b) => b;

    factory DeliverTxResult([void updates(DeliverTxResultBuilder b)]) = _$DeliverTxResult;

    @BuiltValueSerializer(custom: true)
    static Serializer<DeliverTxResult> get serializer => _$DeliverTxResultSerializer();
}

class _$DeliverTxResultSerializer implements StructuredSerializer<DeliverTxResult> {
    @override
    final Iterable<Type> types = const [DeliverTxResult, _$DeliverTxResult];

    @override
    final String wireName = r'DeliverTxResult';

    @override
    Iterable<Object?> serialize(Serializers serializers, DeliverTxResult object,
    ...
    @override
    DeliverTxResult deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = DeliverTxResultBuilder();
