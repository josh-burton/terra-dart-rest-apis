...
part 'getallvalidatorcandidates_bydefaultitreturnsonlythebondedvalidators_response.g.dart';
...
/// * [unbondingTime] 
/// * [commission] 
abstract class GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse implements Built<GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse, GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponseBuilder> {
    ...
    GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponseBuilder b) => b;

    factory GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse([void updates(GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponseBuilder b)]) = _$GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse> get serializer => _$GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponseSerializer();
}

class _$GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponseSerializer implements StructuredSerializer<GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse> {
    @override
    final Iterable<Type> types = const [GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse, _$GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse];

    @override
    final String wireName = r'GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse object,
    ...
    @override
    GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = GetallvalidatorcandidatesBydefaultitreturnsonlythebondedvalidatorsResponseBuilder();
