...
part of 'queryproposals_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$QueryproposalsResponse extends QueryproposalsResponse {
  @override
  final String? id;
  @override
  ...
  factory _$QueryproposalsResponse(
          [void Function(QueryproposalsResponseBuilder)? updates]) =>
      (new QueryproposalsResponseBuilder()..update(updates))._build();

  _$QueryproposalsResponse._(
      {this.id,
      this.content,
      this.status,
  ...
  @override
  QueryproposalsResponse rebuild(
          void Function(QueryproposalsResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  QueryproposalsResponseBuilder toBuilder() =>
      new QueryproposalsResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is QueryproposalsResponse &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'QueryproposalsResponse')
          ..add('id', id)
          ..add('content', content)
          ..add('status', status)
...
class QueryproposalsResponseBuilder
    implements Builder<QueryproposalsResponse, QueryproposalsResponseBuilder> {
  _$QueryproposalsResponse? _$v;
  ...
  QueryproposalsResponseBuilder() {
    QueryproposalsResponse._defaults(this);
  }

  QueryproposalsResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(QueryproposalsResponse other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$QueryproposalsResponse;
  }

  @override
  void update(void Function(QueryproposalsResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  QueryproposalsResponse build() => _build();

  _$QueryproposalsResponse _build() {
    _$QueryproposalsResponse _$result;
    try {
      _$result = _$v ??
          new _$QueryproposalsResponse._(
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'QueryproposalsResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
