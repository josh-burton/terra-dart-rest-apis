...
/// * [validatorIndex] 
/// * [signature] 
abstract class VoteA implements Built<VoteA, VoteABuilder> {
    ...
    static void _defaults(VoteABuilder b) => b;

    factory VoteA([void updates(VoteABuilder b)]) = _$VoteA;

    @BuiltValueSerializer(custom: true)
    static Serializer<VoteA> get serializer => _$VoteASerializer();
}

class _$VoteASerializer implements StructuredSerializer<VoteA> {
    @override
    final Iterable<Type> types = const [VoteA, _$VoteA];

    @override
    final String wireName = r'VoteA';

    @override
    Iterable<Object?> serialize(Serializers serializers, VoteA object,
    ...
    @override
    VoteA deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = VoteABuilder();
