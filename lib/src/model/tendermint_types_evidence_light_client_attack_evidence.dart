...
part 'tendermint_types_evidence_light_client_attack_evidence.g.dart';
...
/// * [totalVotingPower] 
/// * [timestamp] 
abstract class TendermintTypesEvidenceLightClientAttackEvidence implements Built<TendermintTypesEvidenceLightClientAttackEvidence, TendermintTypesEvidenceLightClientAttackEvidenceBuilder> {
    ...
    TendermintTypesEvidenceLightClientAttackEvidence._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(TendermintTypesEvidenceLightClientAttackEvidenceBuilder b) => b;

    factory TendermintTypesEvidenceLightClientAttackEvidence([void updates(TendermintTypesEvidenceLightClientAttackEvidenceBuilder b)]) = _$TendermintTypesEvidenceLightClientAttackEvidence;

    @BuiltValueSerializer(custom: true)
    static Serializer<TendermintTypesEvidenceLightClientAttackEvidence> get serializer => _$TendermintTypesEvidenceLightClientAttackEvidenceSerializer();
}

class _$TendermintTypesEvidenceLightClientAttackEvidenceSerializer implements StructuredSerializer<TendermintTypesEvidenceLightClientAttackEvidence> {
    @override
    final Iterable<Type> types = const [TendermintTypesEvidenceLightClientAttackEvidence, _$TendermintTypesEvidenceLightClientAttackEvidence];

    @override
    final String wireName = r'TendermintTypesEvidenceLightClientAttackEvidence';

    @override
    Iterable<Object?> serialize(Serializers serializers, TendermintTypesEvidenceLightClientAttackEvidence object,
    ...
    @override
    TendermintTypesEvidenceLightClientAttackEvidence deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TendermintTypesEvidenceLightClientAttackEvidenceBuilder();
