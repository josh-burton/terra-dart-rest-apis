...
/// * [validatorIndex] 
/// * [signature] 
abstract class VoteB implements Built<VoteB, VoteBBuilder> {
    ...
    static void _defaults(VoteBBuilder b) => b;

    factory VoteB([void updates(VoteBBuilder b)]) = _$VoteB;

    @BuiltValueSerializer(custom: true)
    static Serializer<VoteB> get serializer => _$VoteBSerializer();
}

class _$VoteBSerializer implements StructuredSerializer<VoteB> {
    @override
    final Iterable<Type> types = const [VoteB, _$VoteB];

    @override
    final String wireName = r'VoteB';

    @override
    Iterable<Object?> serialize(Serializers serializers, VoteB object,
    ...
    @override
    VoteB deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = VoteBBuilder();
