...
abstract class Validators7 implements Built<Validators7, Validators7Builder> {
    ...
    static void _defaults(Validators7Builder b) => b;

    factory Validators7([void updates(Validators7Builder b)]) = _$Validators7;

    @BuiltValueSerializer(custom: true)
    static Serializer<Validators7> get serializer => _$Validators7Serializer();
}

class _$Validators7Serializer implements StructuredSerializer<Validators7> {
    @override
    final Iterable<Type> types = const [Validators7, _$Validators7];

    @override
    final String wireName = r'Validators7';

    @override
    Iterable<Object?> serialize(Serializers serializers, Validators7 object,
    ...
    @override
    Validators7 deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = Validators7Builder();
