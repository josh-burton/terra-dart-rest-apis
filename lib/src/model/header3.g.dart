...
part of 'header3.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$Header3 extends Header3 {
  @override
  ...
  factory _$Header3([void Function(Header3Builder)? updates]) =>
      (new Header3Builder()..update(updates))._build();
  ...
  @override
  Header3 rebuild(void Function(Header3Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  Header3Builder toBuilder() => new Header3Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Header3 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Header3')
          ..add('version', version)
          ..add('chainId', chainId)
          ..add('height', height)
          ..add('time', time)
...
class Header3Builder implements Builder<Header3, Header3Builder> {
  _$Header3? _$v;
  ...
  Header3Builder() {
    Header3._defaults(this);
  }

  Header3Builder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(Header3 other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Header3;
  }

  @override
  void update(void Function(Header3Builder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  Header3 build() => _build();
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Header3', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
