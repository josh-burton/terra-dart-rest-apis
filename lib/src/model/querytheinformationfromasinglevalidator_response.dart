...
part 'querytheinformationfromasinglevalidator_response.g.dart';
...
/// * [unbondingTime] 
/// * [commission] 
abstract class QuerytheinformationfromasinglevalidatorResponse implements Built<QuerytheinformationfromasinglevalidatorResponse, QuerytheinformationfromasinglevalidatorResponseBuilder> {
    ...
    QuerytheinformationfromasinglevalidatorResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(QuerytheinformationfromasinglevalidatorResponseBuilder b) => b;

    factory QuerytheinformationfromasinglevalidatorResponse([void updates(QuerytheinformationfromasinglevalidatorResponseBuilder b)]) = _$QuerytheinformationfromasinglevalidatorResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<QuerytheinformationfromasinglevalidatorResponse> get serializer => _$QuerytheinformationfromasinglevalidatorResponseSerializer();
}

class _$QuerytheinformationfromasinglevalidatorResponseSerializer implements StructuredSerializer<QuerytheinformationfromasinglevalidatorResponse> {
    @override
    final Iterable<Type> types = const [QuerytheinformationfromasinglevalidatorResponse, _$QuerytheinformationfromasinglevalidatorResponse];

    @override
    final String wireName = r'QuerytheinformationfromasinglevalidatorResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, QuerytheinformationfromasinglevalidatorResponse object,
    ...
    @override
    QuerytheinformationfromasinglevalidatorResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = QuerytheinformationfromasinglevalidatorResponseBuilder();
