...
part 'unbonding_response.g.dart';
...
abstract class UnbondingResponse implements Built<UnbondingResponse, UnbondingResponseBuilder> {
    ...
    static void _defaults(UnbondingResponseBuilder b) => b;

    factory UnbondingResponse([void updates(UnbondingResponseBuilder b)]) = _$UnbondingResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<UnbondingResponse> get serializer => _$UnbondingResponseSerializer();
}

class _$UnbondingResponseSerializer implements StructuredSerializer<UnbondingResponse> {
    @override
    final Iterable<Type> types = const [UnbondingResponse, _$UnbondingResponse];

    @override
    final String wireName = r'UnbondingResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, UnbondingResponse object,
    ...
    @override
    UnbondingResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = UnbondingResponseBuilder();
