...
part of 'validator11.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$Validator11 extends Validator11 {
  @override
  ...
  factory _$Validator11([void Function(Validator11Builder)? updates]) =>
      (new Validator11Builder()..update(updates))._build();
  ...
  @override
  Validator11 rebuild(void Function(Validator11Builder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  Validator11Builder toBuilder() => new Validator11Builder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Validator11 &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Validator11')
...
class Validator11Builder implements Builder<Validator11, Validator11Builder> {
  _$Validator11? _$v;
  ...
  Validator11Builder() {
    Validator11._defaults(this);
  }

  Validator11Builder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(Validator11 other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Validator11;
  }

  @override
  void update(void Function(Validator11Builder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  Validator11 build() => _build();

  _$Validator11 _build() {
    _$Validator11 _$result;
    try {
      _$result = _$v ??
          new _$Validator11._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Validator11', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
