...
part of 'cosmos_auth_v1beta1_params.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CosmosAuthV1beta1Params extends CosmosAuthV1beta1Params {
  @override
  ...
  factory _$CosmosAuthV1beta1Params(
          [void Function(CosmosAuthV1beta1ParamsBuilder)? updates]) =>
      (new CosmosAuthV1beta1ParamsBuilder()..update(updates))._build();

  _$CosmosAuthV1beta1Params._(
  ...
  @override
  CosmosAuthV1beta1Params rebuild(
          void Function(CosmosAuthV1beta1ParamsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CosmosAuthV1beta1ParamsBuilder toBuilder() =>
      new CosmosAuthV1beta1ParamsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CosmosAuthV1beta1Params &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CosmosAuthV1beta1Params')
...
class CosmosAuthV1beta1ParamsBuilder
    implements
        Builder<CosmosAuthV1beta1Params, CosmosAuthV1beta1ParamsBuilder> {
  _$CosmosAuthV1beta1Params? _$v;
  ...
  CosmosAuthV1beta1ParamsBuilder() {
    CosmosAuthV1beta1Params._defaults(this);
  }

  CosmosAuthV1beta1ParamsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(CosmosAuthV1beta1Params other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$CosmosAuthV1beta1Params;
  }

  @override
  void update(void Function(CosmosAuthV1beta1ParamsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  CosmosAuthV1beta1Params build() => _build();

  _$CosmosAuthV1beta1Params _build() {
    final _$result = _$v ??
        new _$CosmosAuthV1beta1Params._(
