...
/// * [accountAddress] 
/// * [selfDelegation] 
abstract class Validator15 implements Built<Validator15, Validator15Builder> {
    ...
    static void _defaults(Validator15Builder b) => b;

    factory Validator15([void updates(Validator15Builder b)]) = _$Validator15;

    @BuiltValueSerializer(custom: true)
    static Serializer<Validator15> get serializer => _$Validator15Serializer();
}

class _$Validator15Serializer implements StructuredSerializer<Validator15> {
    @override
    final Iterable<Type> types = const [Validator15, _$Validator15];

    @override
    final String wireName = r'Validator15';

    @override
    Iterable<Object?> serialize(Serializers serializers, Validator15 object,
    ...
    @override
    Validator15 deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = Validator15Builder();
