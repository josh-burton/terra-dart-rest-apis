...
part of 'staking_params200_response_params.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$StakingParams200ResponseParams extends StakingParams200ResponseParams {
  @override
  ...
  factory _$StakingParams200ResponseParams(
          [void Function(StakingParams200ResponseParamsBuilder)? updates]) =>
      (new StakingParams200ResponseParamsBuilder()..update(updates))._build();

  _$StakingParams200ResponseParams._(
      {this.unbondingTime,
      this.maxValidators,
      this.maxEntries,
  ...
  @override
  StakingParams200ResponseParams rebuild(
          void Function(StakingParams200ResponseParamsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  StakingParams200ResponseParamsBuilder toBuilder() =>
      new StakingParams200ResponseParamsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is StakingParams200ResponseParams &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'StakingParams200ResponseParams')
...
class StakingParams200ResponseParamsBuilder
    implements
        Builder<StakingParams200ResponseParams,
            StakingParams200ResponseParamsBuilder> {
  _$StakingParams200ResponseParams? _$v;
  ...
  StakingParams200ResponseParamsBuilder() {
    StakingParams200ResponseParams._defaults(this);
  }

  StakingParams200ResponseParamsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(StakingParams200ResponseParams other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$StakingParams200ResponseParams;
  }

  @override
  void update(void Function(StakingParams200ResponseParamsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  StakingParams200ResponseParams build() => _build();

  _$StakingParams200ResponseParams _build() {
    final _$result = _$v ??
        new _$StakingParams200ResponseParams._(
