...
/// * [evidenceHash] 
/// * [proposerAddress] 
abstract class Header3 implements Built<Header3, Header3Builder> {
    ...
    static void _defaults(Header3Builder b) => b;

    factory Header3([void updates(Header3Builder b)]) = _$Header3;

    @BuiltValueSerializer(custom: true)
    static Serializer<Header3> get serializer => _$Header3Serializer();
}

class _$Header3Serializer implements StructuredSerializer<Header3> {
    @override
    final Iterable<Type> types = const [Header3, _$Header3];

    @override
    final String wireName = r'Header3';

    @override
    Iterable<Object?> serialize(Serializers serializers, Header3 object,
    ...
    @override
    Header3 deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = Header3Builder();
