...
class _$VoteA extends VoteA {
  ...
  factory _$VoteA([void Function(VoteABuilder)? updates]) =>
      (new VoteABuilder()..update(updates))._build();
  ...
  @override
  VoteA rebuild(void Function(VoteABuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  VoteABuilder toBuilder() => new VoteABuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is VoteA &&
        type == other.type &&
        height == other.height &&
        round == other.round &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'VoteA')
          ..add('type', type)
          ..add('height', height)
          ..add('round', round)
          ..add('blockId', blockId)
...
class VoteABuilder implements Builder<VoteA, VoteABuilder> {
  _$VoteA? _$v;
  ...
  VoteABuilder() {
    VoteA._defaults(this);
  }

  VoteABuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _type = $v.type;
      _height = $v.height;
  ...
  @override
  void replace(VoteA other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$VoteA;
  }

  @override
  void update(void Function(VoteABuilder)? updates) {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'VoteA', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
