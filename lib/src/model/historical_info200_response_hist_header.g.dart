...
part of 'historical_info200_response_hist_header.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$HistoricalInfo200ResponseHistHeader
    extends HistoricalInfo200ResponseHistHeader {
  @override
  ...
  final DateTime? time;
  @override
  final PrevBlockInfo? lastBlockId;
  @override
  ...
  factory _$HistoricalInfo200ResponseHistHeader(
          [void Function(HistoricalInfo200ResponseHistHeaderBuilder)?
              updates]) =>
      (new HistoricalInfo200ResponseHistHeaderBuilder()..update(updates))
          ._build();

  _$HistoricalInfo200ResponseHistHeader._(
      {this.version,
      this.chainId,
      this.height,
      this.time,
  ...
  @override
  HistoricalInfo200ResponseHistHeader rebuild(
          void Function(HistoricalInfo200ResponseHistHeaderBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  HistoricalInfo200ResponseHistHeaderBuilder toBuilder() =>
      new HistoricalInfo200ResponseHistHeaderBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HistoricalInfo200ResponseHistHeader &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HistoricalInfo200ResponseHistHeader')
          ..add('version', version)
          ..add('chainId', chainId)
          ..add('height', height)
          ..add('time', time)
...
class HistoricalInfo200ResponseHistHeaderBuilder
    implements
        Builder<HistoricalInfo200ResponseHistHeader,
            HistoricalInfo200ResponseHistHeaderBuilder> {
  _$HistoricalInfo200ResponseHistHeader? _$v;
  ...
  PrevBlockInfoBuilder? _lastBlockId;
  PrevBlockInfoBuilder get lastBlockId =>
      _$this._lastBlockId ??= new PrevBlockInfoBuilder();
  set lastBlockId(PrevBlockInfoBuilder? lastBlockId) =>
  ...
  HistoricalInfo200ResponseHistHeaderBuilder() {
    HistoricalInfo200ResponseHistHeader._defaults(this);
  }

  HistoricalInfo200ResponseHistHeaderBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HistoricalInfo200ResponseHistHeader other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$HistoricalInfo200ResponseHistHeader;
  }
  ...
  @override
  HistoricalInfo200ResponseHistHeader build() => _build();

  _$HistoricalInfo200ResponseHistHeader _build() {
    _$HistoricalInfo200ResponseHistHeader _$result;
    try {
      _$result = _$v ??
          new _$HistoricalInfo200ResponseHistHeader._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'HistoricalInfo200ResponseHistHeader',
            _$failedField,
            e.toString());
      }
      rethrow;
