...
class _$Valset extends Valset {
  ...
  factory _$Valset([void Function(ValsetBuilder)? updates]) =>
      (new ValsetBuilder()..update(updates))._build();
  ...
  @override
  Valset rebuild(void Function(ValsetBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ValsetBuilder toBuilder() => new ValsetBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Valset &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Valset')
...
class ValsetBuilder implements Builder<Valset, ValsetBuilder> {
  _$Valset? _$v;
  ...
  ValsetBuilder() {
    Valset._defaults(this);
  }

  ValsetBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(Valset other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Valset;
  }

  @override
  void update(void Function(ValsetBuilder)? updates) {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Valset', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
