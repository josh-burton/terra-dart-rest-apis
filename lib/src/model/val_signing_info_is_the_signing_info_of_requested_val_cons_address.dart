...
part 'val_signing_info_is_the_signing_info_of_requested_val_cons_address.g.dart';
...
abstract class ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress implements Built<ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress, ValSigningInfoIsTheSigningInfoOfRequestedValConsAddressBuilder> {
    ...
    ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(ValSigningInfoIsTheSigningInfoOfRequestedValConsAddressBuilder b) => b;

    factory ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress([void updates(ValSigningInfoIsTheSigningInfoOfRequestedValConsAddressBuilder b)]) = _$ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress;

    @BuiltValueSerializer(custom: true)
    static Serializer<ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress> get serializer => _$ValSigningInfoIsTheSigningInfoOfRequestedValConsAddressSerializer();
}

class _$ValSigningInfoIsTheSigningInfoOfRequestedValConsAddressSerializer implements StructuredSerializer<ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress> {
    @override
    final Iterable<Type> types = const [ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress, _$ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress];

    @override
    final String wireName = r'ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress';

    @override
    Iterable<Object?> serialize(Serializers serializers, ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress object,
    ...
    @override
    ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ValSigningInfoIsTheSigningInfoOfRequestedValConsAddressBuilder();
