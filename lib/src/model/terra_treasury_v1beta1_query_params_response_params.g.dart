...
part of 'terra_treasury_v1beta1_query_params_response_params.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$TerraTreasuryV1beta1QueryParamsResponseParams
    extends TerraTreasuryV1beta1QueryParamsResponseParams {
  @override
  ...
  factory _$TerraTreasuryV1beta1QueryParamsResponseParams(
          [void Function(TerraTreasuryV1beta1QueryParamsResponseParamsBuilder)?
              updates]) =>
      (new TerraTreasuryV1beta1QueryParamsResponseParamsBuilder()
            ..update(updates))
          ._build();

  _$TerraTreasuryV1beta1QueryParamsResponseParams._(
      {this.taxPolicy,
      this.rewardPolicy,
  ...
  @override
  TerraTreasuryV1beta1QueryParamsResponseParams rebuild(
          void Function(TerraTreasuryV1beta1QueryParamsResponseParamsBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TerraTreasuryV1beta1QueryParamsResponseParamsBuilder toBuilder() =>
      new TerraTreasuryV1beta1QueryParamsResponseParamsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TerraTreasuryV1beta1QueryParamsResponseParams &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'TerraTreasuryV1beta1QueryParamsResponseParams')
...
class TerraTreasuryV1beta1QueryParamsResponseParamsBuilder
    implements
        Builder<TerraTreasuryV1beta1QueryParamsResponseParams,
            TerraTreasuryV1beta1QueryParamsResponseParamsBuilder> {
  _$TerraTreasuryV1beta1QueryParamsResponseParams? _$v;
  ...
  TerraTreasuryV1beta1QueryParamsResponseParamsBuilder() {
    TerraTreasuryV1beta1QueryParamsResponseParams._defaults(this);
  }

  TerraTreasuryV1beta1QueryParamsResponseParamsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(TerraTreasuryV1beta1QueryParamsResponseParams other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$TerraTreasuryV1beta1QueryParamsResponseParams;
  }
  ...
  @override
  TerraTreasuryV1beta1QueryParamsResponseParams build() => _build();

  _$TerraTreasuryV1beta1QueryParamsResponseParams _build() {
    _$TerraTreasuryV1beta1QueryParamsResponseParams _$result;
    try {
      _$result = _$v ??
          new _$TerraTreasuryV1beta1QueryParamsResponseParams._(
