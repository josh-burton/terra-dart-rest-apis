...
part 'light_client_attack_evidence.g.dart';
...
/// * [totalVotingPower] 
/// * [timestamp] 
abstract class LightClientAttackEvidence implements Built<LightClientAttackEvidence, LightClientAttackEvidenceBuilder> {
    ...
    LightClientAttackEvidence._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(LightClientAttackEvidenceBuilder b) => b;

    factory LightClientAttackEvidence([void updates(LightClientAttackEvidenceBuilder b)]) = _$LightClientAttackEvidence;

    @BuiltValueSerializer(custom: true)
    static Serializer<LightClientAttackEvidence> get serializer => _$LightClientAttackEvidenceSerializer();
}

class _$LightClientAttackEvidenceSerializer implements StructuredSerializer<LightClientAttackEvidence> {
    @override
    final Iterable<Type> types = const [LightClientAttackEvidence, _$LightClientAttackEvidence];

    @override
    final String wireName = r'LightClientAttackEvidence';

    @override
    Iterable<Object?> serialize(Serializers serializers, LightClientAttackEvidence object,
    ...
    @override
    LightClientAttackEvidence deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = LightClientAttackEvidenceBuilder();
